...
namespace Demo.Tests
{
    public class AssertingCollectionsTests
    {
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("William", 10000);
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("William", 1000);
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("William", 15000);
